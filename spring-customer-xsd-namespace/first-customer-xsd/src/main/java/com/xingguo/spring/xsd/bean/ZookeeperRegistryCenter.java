...
/**
 *  zookeeper 注册中心 实现类(copy com.dangdang.ddframe.job.reg.zookeeper.ZookeeperRegistryCenter)
 *
 * @author xingguo
 * @date 5/15/2019 11:14 AM
 * @since 1.0.0
 **/
@Slf4j
public class ZookeeperRegistryCenter implements CoordinatorRegistryCenter {
    ...
    /**
     * 声明 zk配置类 变量; 且 提供get方法,但访问范围就是位于同一个包下的类或者其子类中可以访问
     */
